...
const LoginPage = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "linear-gradient(135deg, #132a53 0%, #1b2d6b 35%, #2b0b66 70%, #431c7a 100%)" }}>
      ...
      >
        <h2 style={{ margin: 0, textAlign: "center", fontFamily: "'Brush Script MT', cursive", fontWeight: "bold", color: "white" }}>Log in</h2>
        <p style={{ marginTop: ".25rem", color: "white", textAlign: "center", fontFamily: "'Brush Script MT', cursive", fontWeight: "bold" }}>Welcome back 👋</p>
        ...
        <label style={{ display: "block", marginTop: "1rem" }}>
          ...
          <input
            ...
            required
            style={{ width: "95%", marginTop: ".35rem", marginLeft: "auto", marginRight: "auto", padding: ".6rem", borderRadius: "8px", border: "1px solid #cbd5e1" }}
          />
        </label>
        ...
        <div style={{ marginTop: ".8rem", textAlign: "center", fontFamily: "'Brush Script MT', cursive", fontWeight: "bold", color: "white" }}>
          New here? <Link to="/register" style={{ cursor: "pointer", color: "#87ceeb", transition: "color 0.3s ease" }}
